    ...
    if ret:
        ...
        if(cnts != ([], None)):
            ...
            for c in cnts:
                    ...
                    pixelsPerMetric_length = referenceHeight_length/Height*referencepixelsPerMetric_length/1.02
...
button(840, 360+25+35-10, "+", cmd=lengthIncrease,width_=2, height_ = 1,border_=1)
button(840, 390+25+35, "+", cmd=BreadthIncrease,width_=2, height_ = 1,border_=1)
