...
# glob.glob("D:/DMS/calibration/*.png")
    ...
    destnation = path.join('calibration_pickle.p')
...
if __name__ == "__main__":
    ...
    nx, ny = 6,8 # number of grids along x and y axis in the chessboard pattern
    # basepath = 'camera_cal/'  # path contain the calibration images

    # calibrate the camera and save the calibration data
    # calibrate_camera(nx, ny)
    # undistort_image()
    undistort_image('Boxes/b18p10.png','calibration_pickle.p',True)
